...
// //                 Rating: {appliance.starRating} ★
// //               </p>
// //               <p className="text-gray-500">Warranty: {appliance.warranty}</p>
// //               <p className="text-gray-500">Guarantee: {appliance.guarantee}</p>
...
// //               <div className="mb-4">
// //                 <label className="block text-gray-700 mb-2">Warranty (Months)</label>
// //                 <input
// //                   type="text"
// //                   name="warranty"
...
// //               <div className="mb-4">
// //                 <label className="block text-gray-700 mb-2">Guarantee (Months)</label>
// //                 <input
// //                   type="text"
// //                   name="guarantee"
...
//                 <div>
//                   <label className="block text-gray-700 mb-1">Guarantee (Months)</label>
//                   <input
//                     type="text"
//                     name="guarantee"
//                     value={formData.guarantee}
...
const Appliances = () => {
  ...
  useEffect(() => {
    const fetchAppliances = async () => {
      try {
        const response = await fetch("https://electricity-silk.onrender.com/api/appliances");
        const data = await response.json();
        setAppliances(data);
      } catch (error) {
        console.error("Error fetching appliances:", error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedAppliance) {
        // Update existing appliance
        response = await fetch(
          `https://electricity-silk.onrender.com/api/appliances/${selectedAppliance._id}`,
          {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(formData)
        ...
        // Add new appliance
        response = await fetch("https://electricity-silk.onrender.com/api/appliances", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(formData)
        });
      ...
      // Refresh the appliances list
      const updatedResponse = await fetch("https://electricity-silk.onrender.com/api/appliances");
      const updatedData = await updatedResponse.json();
      setAppliances(updatedData);
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://electricity-silk.onrender.com/api/appliances/${id}`, {
        method: "DELETE"
      });
      // Refresh the appliances list
      const response = await fetch("https://electricity-silk.onrender.com/api/appliances");
