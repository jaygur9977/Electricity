...
// //           <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl border border-white/20 shadow-lg relative overflow-hidden">
// //             <EnergyPulse />
// //             <motion.h1 
...
//   return (
//     <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 w-full md:w-1/3 border border-white/20 shadow-lg">
...
//         <div className="max-w-6xl mx-auto relative flex flex-col md:flex-row gap-8">
//           {/* Weather Widget (Left) */}
//           <WeatherWidget />
...
//             {/* Weather Display (if data available) */}
//             {weatherData && (
//               <motion.div 
//                 className="absolute top-4 right-4 bg-white/20 p-3 rounded-lg backdrop-blur-sm"
//                 initial={{ opacity: 0, y: -20 }}
//                 animate={{ opacity: 1, y: 0 }}
//               >
...
//                     <p className="text-xs opacity-80">{weatherData.location.name}</p>
//                   </div>
//                 </div>
//               </motion.div>
//             )}
